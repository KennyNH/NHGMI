...
def acm_params():
    ...
    parser.add_argument('--mps', type=list, default=['pap', 'psp'])
    parser.add_argument('--rank_ratio', type=float, default=2.)
...
def dblp_params():
    ...
    parser.add_argument('--lam', type=float, default=0.5) 
    parser.add_argument('--gamma', type=float, default=2.)
    parser.add_argument('--mps', type=list, default=['apa', 'apcpa', 'aptpa'])
    parser.add_argument('--rank_ratio', type=float, default=2.)
    parser.add_argument('--verbose', type=int, default=0)
...
def aminer_params():
    ...
    parser.add_argument('--lam', type=float, default=0.5)
    parser.add_argument('--gamma', type=float, default=2.)
    parser.add_argument('--mps', type=list, default=['pap', 'prp'])
    parser.add_argument('--rank_ratio', type=float, default=2.)
    parser.add_argument('--verbose', type=int, default=0)
    parser.add_argument('--num_pos', type=int, default=1)
...
def freebase_params():
    ...
    parser.add_argument('--lam', type=float, default=0.5)
    parser.add_argument('--gamma', type=float, default=2.)
    parser.add_argument('--mps', type=list, default=['mam', 'mdm', 'mwm'])
    parser.add_argument('--rank_ratio', type=float, default=2.)
    parser.add_argument('--verbose', type=int, default=0)
    parser.add_argument('--num_pos', type=int, default=21)
...
def imdb_params():
    ...
    parser.add_argument('--feat_drop', type=float, default=0.4)
    parser.add_argument('--attn_drop', type=float, default=0.35)
    parser.add_argument('--sample_rate', nargs='+', type=int, default=[3, 1, 6])
    parser.add_argument('--lam', type=float, default=0.5)
    parser.add_argument('--gamma', type=float, default=2.)
    parser.add_argument('--mps', type=list, default=['mam', 'mdm', 'mkm'])
    parser.add_argument('--rank_ratio', type=float, default=2.)
    parser.add_argument('--verbose', type=int, default=0)
    parser.add_argument('--num_pos', type=int, default=1)

    args, _ = parser.parse_known_args()
    args.type_num = [3237, 4822, 1941, 7088]  # the number of every node type
    args.nei_num = 3  # the number of neighbors' types
    return args
